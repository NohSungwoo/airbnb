...
class TestAmenity(APITestCase):
    ...
    def test_put_amenity(self):
        ...
        new_amenity_name = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"
        response = self.client.put("/api/v1/rooms/amenities/1", data={"name": new_amenity_name})
        data = response.json()
